...
const SideNav = () => {
    ...
    return (
        <>
            <aside className="flex px-16 space-y-16 overflow-hidden m-3 pb-4 flex-col items-center justify-center rounded-tl-xl rounded-bl-xl bg-[#5C5EDF] shadow-lg">
                <div className="flex items-center justify-center p-4 shadow-lg">
                    ...
                    <h1 className="text-white font-extrabold mr-2 cursor-pointer">Student Portal</h1>
                </div>
                <ul className='h-[70vh]'>
